...
Or for manually specified devices:

```
Elero - Attempting to connect to manually specified device: '/dev/ttyUSB2' with serial number: 'B1234567'
Elero - Successfully connected to manually specified device: '/dev/ttyUSB2' with serial number: 'B1234567'
```
